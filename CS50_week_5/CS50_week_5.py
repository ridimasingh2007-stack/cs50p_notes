# Unit tests:--- testing individual units of the code, those units are mainly fucntions
...
# pytest:-- it's a lib which automates the testing of the code that is written, it comes with builtin conventions.
def main():
